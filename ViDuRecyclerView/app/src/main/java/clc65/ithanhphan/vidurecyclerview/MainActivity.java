package clc65.ithanhphan.vidurecyclerview;
...
//        RecyclerView.LayoutManager layoutGrid = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
//        recyclerViewLandscape.setLayoutManager(layoutGrid);
...
//        recyclerViewLandscape.setLayoutManager(layoutGrid);
    ...
    ArrayList<LandScape> getDataForRecycleView() {
        ...
        dsDuLieu.add(new LandScape("halong", "Vịnh Hạ Long"));
        dsDuLieu.add(new LandScape("nhatho", "Nhà thờ Đức Bà"));
        return dsDuLieu;
    }
}